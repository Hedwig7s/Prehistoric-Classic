...
export interface Protocol {
  ...
  readonly packets: {
    [PacketIds.Identification]: BidirectionalPacket<
      IdentificationPacketData
    >;
    ...
    [PacketIds.PositionAndOrientation]: BidirectionalPacket<
      PositionAndOrientationPacketData
    >;
    [PacketIds.PositionAndOrientationUpdate]: SendablePacket<
      PositionAndOrientationUpdatePacketData
    >;
    [PacketIds.PositionUpdate]: SendablePacket<PositionUpdatePacketData>;
    [PacketIds.OrientationUpdate]: SendablePacket<
      OrientationUpdatePacketData
    >;
    ...
    [PacketIds.DisconnectPlayer]: SendablePacket<
      DisconnectPlayerPacketData
    >;
